...
const CreateAccount: FC<CreateAccountProps> = ({ closeHandler, loginHandler }) => {
  return (
    <div className='create-account bg-white dark:bg-black p-4 w-full'>
      ...
      <form action="" className="flex flex-col gap-1 mt-4">
        ...
        <Button onClick={loginHandler} className="text-black dark:text-white p-0 h-[36px] underline text-xs">
          Login
        </Button>
      </form>
